...
class Author extends Component {
	...
	prepareSort() {
		...
		sortOptions.push(<button className="Author-item" key="newest" onClick={()=>this.handleSort('newest')}><span className={this.state.currentSort === 'newest' ? 'Author-selected' : 'Author-default'}>{this.state.currentSort === 'newest' ? check : ''}Newest</span></button>)
		sortOptions.push(<button className="Author-item" key="oldest" onClick={()=>this.handleSort('oldest')}><span className={this.state.currentSort === 'oldest' ? 'Author-selected' : 'Author-default'} >{this.state.currentSort === 'oldest' ? check : ''}Oldest</span></button>)
		sortOptions.push(<button className="Author-item" key="mostCommented" onClick={()=>this.handleSort('mostCommented')}><span className={this.state.currentSort === 'mostCommented' ? 'Author-selected' : 'Author-default'}>{this.state.currentSort === 'mostCommented' ? check : ''}Most Commented</span></button>)
		sortOptions.push(<button className="Author-item" key="leastCommented" onClick={()=>this.handleSort('leastCommented')}><span className={this.state.currentSort === 'leastCommented' ? 'Author-selected' : 'Author-default'}>{this.state.currentSort === 'leastCommented' ? check : ''}Least Commented</span></button>)
		sortOptions.push(<button className="Author-item" key="recentlyUpdated" onClick={()=>this.handleSort('recentlyUpdated')}><span className={this.state.currentSort === 'recentlyUpdated' ? 'Author-selected' : 'Author-default'}>{this.state.currentSort === 'recentlyUpdated' ? check : ''}Recently Updated</span></button>)
		sortOptions.push(<button className="Author-item" key="leastRecentlyUpdated" onClick={()=>this.handleSort('leastRecentlyUpdated')}><span className={this.state.currentSort === 'leastRecentlyUpdated' ? 'Author-selected' : 'Author-default'}>{this.state.currentSort === 'leastRecentlyUpdated' ? check : ''}Least Recently Updated</span></button>)
